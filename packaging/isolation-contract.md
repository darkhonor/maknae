...
| Property | Host-native Linux (MVP reference; the FIPS module's validated environments are Amazon Linux 2023 on Graviton4 / Xeon 8375C only — see above) | Host-native macOS (deployment target; CI on `macos-26` tests the whole workspace incl. the FIPS surface, green since 2026-09-11; the FIPS module is a *ported*, unvalidated environment here — see above) | Compose/Podman | K8s |
|---|---|---|---|---|
