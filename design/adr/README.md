...
| 0006 | Client authentication (AuthN) model — trust plane is the sole client-facing door; clients never reach Vault; local peer-cred now, OIDC-federated gateway later | Accepted (operator-ratified 2026-08-22) |
