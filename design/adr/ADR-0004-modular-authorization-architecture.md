...
- **`maknae-authz-basic` is BUILT (#85, 2026-08-26)** against this ADR as amended above (v0.1 supersessions recorded in the Amendment block); #77 wires the per-request PDP that calls it. §5's baseline/overlay/`ask`/`subjects:`/`when:` shape remains the growth target, not the shipped v0.1.
