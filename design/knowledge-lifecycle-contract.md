...
5. **Policy language selection** for the kernel — Cedar vs. embedded OPA vs. bespoke; evaluate against hook table (§10) as the acceptance test. *Operator lean 2026-07-14: Cedar (ADR-0003 — Rust-native pairing with the ADR-0002 kernel, formally verified core); the spike confirms or overturns.*
